...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal',
    ...
    ### DSCNET
        ...
        net = DSCNet_pro(n_channels=input_nc, n_classes=output_nc, kernel_size=opt.DSC_kernel, extend_scope=opt.DSC_extend, if_offset=opt.DSC_offset, device=device, number=opt.DSC_number, dim=1,n_blocks=opt.DSC_n_blocks,padding_type=opt.DSE_padding_type,use_dropout=use_dropout)
    else:
